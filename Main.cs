...
namespace HellsingPc
{
    ...
    {
        //bulk up client target and exploits menu, make antis, make spoofers
        ...
        public static bool faceorb = false;
        ...
        public static void MenuStart()
        {
            ...
            var PickupsTarget = new QMNestedButton(ExploitsTarget, 1, 0, "Pickups", "Pickups", "Pickups");
            ...
            {
                HellsingPc.Exploits.Orbit.ToggleOrbit(orbit);
            }, "", true);

            new QMSingleButton(PickupsTarget, 1, 5f, "FaceOrbit", () =>
            {
                HellsingPc.Exploits.Orbit.ToggleFaceOrb(faceorb);
            }, "", true);
