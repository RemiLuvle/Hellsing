...
namespace HellsingCore.ButtonAPI
{
    public static class APIUtils
    {
        ...
        private static VRC.UI.UsernameDisplay _nameplate;
        ...
        private static GameObject _qmWingTemplate;
        private static GameObject _qmTabTemplate;
        private static GameObject _namePlates;
        ...
        public static VRC.UI.UsernameDisplay Nameplateinstance
        {
            get
            {
                if (_nameplate == null)
                    _nameplate = Resources.FindObjectsOfTypeAll<VRC.UI.UsernameDisplay>()[0];
                return _nameplate;
            }
        }
        ...
        public static GameObject GetWingTemplate()
        {
            if (_qmWingTemplate == null)
                _qmWingTemplate = QuickMenuInstance.transform.Find("CanvasGroup/Container/Window/Wing_Left").gameObject;
            return _qmWingTemplate;
        }

        public static GameObject GetNameplateTemplate()
        {
            if (_qmWingTemplate == null)
                _qmWingTemplate = Nameplateinstance.transform.Find("NameplateManager").gameObject;
            return _qmWingTemplate;
        }
