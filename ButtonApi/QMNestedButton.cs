...
namespace HellsingCore.API.QM
{
    public class QMNestedButton : QMMenuBase
    {
        ...
        private void Initialize(bool isRoot, string btnText, float btnPosX, float btnPosY, string btnToolTipText, string menuTitle, bool halfButton)
        {
            ...
            Object.DestroyImmediate(MenuObject.GetComponent<VRC.UI.Elements.Menus.LaunchPadQMMenu>());
            ...
            BackButton.transform.Find("Icon").GetComponent<Image>().overrideSprite = HellsingResources.Resources.LoadSprite("HellsingTab.png");
            ClearChildren();
