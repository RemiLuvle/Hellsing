...
namespace HellsingCore.API.QM
{
    public class QMSingleButton : QMButtonBase
    {
        ...
        private void Initialize(float btnXLocation, float btnYLocation, string btnText, Action btnAction, string btnToolTip)
        {
            ...
            button.transform.Find("Background").GetComponent<Image>().overrideSprite = HellsingResources.Resources.LoadSprite("BG2.png");
            initShift[0] = 0;
            initShift[1] = 0;
            ...
            SetAction(btnAction);
            SetActive(true);
            button.GetComponentInChildren<TMPro.TextMeshProUGUI>().color = Color.white;
        }

        public void SetBackgroundImage(Sprite newImg)
        {
            button.transform.Find("Background").GetComponent<Image>().sprite = newImg;
            button.transform.Find("Background").GetComponent<Image>().overrideSprite = HellsingResources.Resources.LoadSprite("BG1.png");
            RefreshButton();
        }
